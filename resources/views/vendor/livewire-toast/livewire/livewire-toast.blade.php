...
>
    @if($message)
        <div class="flex bg-white  border-l-4 border-{{$bgColorCss}}-500 py-3 px-4 shadow-md mb-2 ">
            <!-- icons -->
            @if($showIcon)
                <div>
                    <div class="text-{{$bgColorCss}}-500 rounded-full border border-{{$bgColorCss}}-500 bg-white mr-3">
